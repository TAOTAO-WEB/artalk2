...
//        arFragment = (ArFragment) getSupportFragmentManager().findFragmentById(R.id.ux_fragment);
        ...
        // 创建对GltfActivity的弱引用，内存不足，直接回收。
        WeakReference<ScanActivity> weakActivity = new WeakReference<>(this);
        ...
        ModelRenderable.builder()
                .setSource(
                        ...
                        R.raw.audio_3d
//            Uri.parse(
//                    "android.resource://raw/audio_3d.glb"
//                    "android.resource://"+ R.raw.audio_3d
...
//            )
                ...
                .thenAccept(
                        modelRenderable -> {
                            ...
                            if (activity != null) {   // 如果内存充足，activity没有被回收
